...
(define (eval exp env)
	(cond ((self-evaluating? exp) exp)
	        ...
	        ((quoted? exp) (eval (make-cons (text-of-quotation exp)) env))
	        ((quoted-old? exp) (text-of-quotation exp))
...
(define (quoted-old? exp) (tagged-list? exp 'quote-old))
...
(define (make-cons exp)
	(if (null? exp)
		'()
		(list 'cons (list 'quote-old (car exp)) (make-cons (cdr exp)))
	)
)
...
(define (make-list-proc text env)
